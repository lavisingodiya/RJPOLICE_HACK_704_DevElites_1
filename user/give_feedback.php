...
<form method="post">
  <fieldset>
    ...
    <fieldset>
      ...
      <button type="button"
        style="font-size:7pt;color:white;background-color:green;border:2px solid #336600;padding:3px">Strongly Agree
        5</button>
      <button type="button"
        style="font-size:7pt;color:white;background-color:Brown;border:2px solid #336600;padding:3px">Agree 4</button>
      <button type="button"
        style="font-size:7pt;color:white;background-color:blue;border:2px solid #336600;padding:3px">Neutral 3</button>
      <button type="button"
        style="font-size:7pt;color:white;background-color:Black;border:2px solid #336600;padding:3px"> Disagree
        2</button>
      <button type="button"
        style="font-size:7pt;color:white;background-color:red;border:2px solid #336600;padding:3px">Strongly Disagree
        1</button><br>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td>
            <b>3:</b>How quickly did the police respond to your needs?
          </td>
          <td>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td>
            <b>5:</b>How helpful were the police in addressing your concerns?
          </td>
          <td>
        ...
        <tr>
          <td>
            <b>7:</b> How well the police understood your situation.
          </td>
        ...
        <tr>
          <td>
            <b>8:</b> How fairly you believe you were treated by the police.
          </td>
          <td>
        ...
        <tr>
          <td>
            <b>9:</b> How empathetic were the police officers in understanding your emotions or concerns?
          </td>
        ...
        <tr>
          <td>
            <b>10:</b> How safe do you feel in your neighborhood, considering the police presence?
          </td>
          <td>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td><b>12:</b>How inclusive and respectful you think the police are towards people of different backgrounds.
          </td>
          <Td>
      ...
      <p align="center"><button type="submit"
          style="font-size:7pt;color:white;background-color:brown;border:2px solid #336600;padding:7px"
          name="sub">Submitt</button></p>
