...
if (isset($save)) {
	if (strlen($mob) < 10 || strlen($mob) > 10) {
		...
		if ($r) {
			...
			$err = "<font color='green'>New Station Successfully Added.</font>";
		}
	}
}
...
<div class="col-lg-8" style="margin:15px;">
	<form method="post">
		...
		<div class="control-group form-group">
			<div class="controls">
				<label>Station Mobile Number:</label>
				<input type="number" id="mob" value="<?php echo @$mob; ?>" class="form-control" maxlength="10" name="mob"
					required>
			</div>
		</div>
		...
		<div class="control-group form-group">
			<div class="controls">
				<input type="submit" class="btn btn-success" name="save" value="Add New Station">
			</div>
		</div>
	</form>
